  ...
  const { data: rows = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        .from("customers")
        .select("id, name, business_name, phone, email, city, business_niche, business_niche_details, signed_agreement_at, signed_agreement_name, signed_agreement_version, payment_method_on_file, status, created_at")
