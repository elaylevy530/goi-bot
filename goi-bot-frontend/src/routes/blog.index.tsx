...
export const Route = createFileRoute("/blog/")({
  ...
  component: BlogMovedPage,
});

function BlogMovedPage() {
  const target = `${externalApps.landing}/blog`;
  useEffect(() => {
  ...
  return (
    ...
    >
      <div>
        <p className="text-lg font-bold">הבלוג עבר לאתר השיווק</p>
        <a
          href={target}
