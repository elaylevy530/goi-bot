...
export const Route = createFileRoute("/deliveries")({
  head: () => ({
    meta: [
      { title: "משלוחים Goi — שליח אצלכם תוך דקות" },
      {
        name: "description",
        content:
          "צריכים לשלוח משהו? Goi מחברת אתכם לשליחים זמינים למשלוחים דחופים, איסוף חבילות ומסירות מהירות. עקבו אחר השליח במפה ושלמו בביטחון.",
      },
      { property: "og:title", content: "משלוחים Goi — שולחים בקלות" },
      {
        property: "og:description",
        content:
          "משלוחים מהירים בכמה נגיעות. מפה חיה, צ׳אט עם השליח ואישור מסירה — הכל באפליקציה של Goi.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: SITE_URL + "/deliveries" },
      { property: "og:image", content: OG_IMAGE },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: OG_IMAGE },
      { name: "viewport", content: "width=device-width, initial-scale=1" },
    ],
    links: [{ rel: "canonical", href: SITE_URL + "/deliveries" }],
  }),
    ...
    <section className="relative overflow-hidden bg-[#0A0B0D] text-white">
      ...
      <div className="relative max-w-[1240px] mx-auto px-4 sm:px-5 lg:px-10 pt-24 sm:pt-28 lg:pt-32 pb-6 lg:pb-10 grid lg:grid-cols-[1.05fr_0.95fr] gap-6 sm:gap-10 lg:gap-14 items-center">
        <div className="text-center lg:text-right">
          ...
          >
            צריך שליח דחוף
            <span className="block mt-1">או איסוף חבילה?</span>
          ...
          <p className="mt-4 lg:mt-7 text-[15px] sm:text-[18px] lg:text-[19.5px] leading-[1.6] sm:leading-[1.7] text-white/60 max-w-[560px] mx-auto lg:mx-0">
            <span className="font-semibold text-white/90">שליח אצלכם תוך דקות לאיסוף ומסירה.</span>
            <span className="block mt-1.5 sm:mt-2">מפה חיה בזמן אמת, צ'אט עם השליח ותשלום נוח.</span>
            <span className="block mt-2 sm:mt-3 font-semibold text-white/90">בלי עיכובים. בלי סיבוכים. פשוט שולחים.</span>
          </p>
