    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-primary-deep px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary-deep/90"
          >
            חזרה לדף הבית
          </Link>
        </div>
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <AdminPreviewBanner />
      <Outlet />
      <Toaster position="top-center" richColors offset="max(0.75rem, env(safe-area-inset-top))" />
      <UpdateBanner />
      <InstallBanner />
    </QueryClientProvider>
  );
