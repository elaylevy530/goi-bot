...
export type CourierNotificationFilter = "all" | CourierNotificationCategory;

export const COURIER_NOTIFICATION_CATEGORY_LABEL: Record<CourierNotificationCategory, string> = {
  system: "מערכת",
  bonus: "בונוסים",
  wallet: "ארנק",
  jobs: "משלוחים",
...
/** Stored explicit category wins; default "system" still infers from content. */
