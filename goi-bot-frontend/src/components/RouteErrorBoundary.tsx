    ...
    <div dir="rtl" className="flex min-h-[60vh] items-center justify-center p-6">
      <div className="max-w-md w-full rounded-2xl border border-border bg-card p-6 text-center shadow-sm">
        ...
        <button
          ...
          className="mt-5 inline-flex items-center justify-center gap-2 rounded-md bg-primary-deep px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary-deep/90"
        >
